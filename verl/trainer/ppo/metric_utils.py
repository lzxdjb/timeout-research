...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> dict[str, Any]:
    ...
    protocol_fields = (
        ...
        "verification_aux_v1_enabled",
        "verification_aux_claude_like",
        "verification_loop_aux_reward_enabled",
        "verification_loop_aux_reward_max",
        "verification_loop_aux_reward_eligible",
        "verification_loop_aux_reward_applied",
        "verification_loop_aux_reward",
        "verification_loop_count",
        "verification_fail_to_pass",
        "verification_diversity_aux_reward_enabled",
        "verification_diversity_aux_reward_max",
        "verification_diversity_aux_reward_eligible",
        "verification_diversity_aux_reward_applied",
        "verification_diversity_aux_reward",
        "verification_diversity_targeted_pass",
        "verification_diversity_broad_pass",
        "verification_diversity_scope_count",
    )
